...
function renderMissions(state) {
    ...
    list.replaceChildren(
        ...missions.map((mission, index) => {
            ...
            // The day's hard mission (HARD_MISSION_POOL in api/_lib.js) takes
            // gold rather than the rotating accent its two neighbours use -
            // enough to set apart the one that pays double and runs slower,

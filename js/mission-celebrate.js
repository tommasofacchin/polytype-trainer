    ...
    function show(missions) {
        ...
        overlay.innerHTML = `
            <div class="mission-overlay-art">
                ...
                <svg class="mission-overlay-icon" width="110" height="110" viewBox="0 0 24 24" fill="none" stroke="#ffa24b" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M8 21h8"/>
                    <path d="M12 17v4"/>
                    <path d="M7 4h10v5a5 5 0 0 1-10 0z" fill="rgba(255, 162, 75,0.18)"/>

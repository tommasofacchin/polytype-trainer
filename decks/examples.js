...
window.DECK_EXAMPLES = {
  ...
  spanish: {
    ...
    151: [
      { text: "El niño tiene una *nariz* pequeña.", translation: "The child has a small nose." },
      { text: "Respiro por la *nariz*.", translation: "I breathe through my nose." },
      { text: "Tiene la *nariz* tapada.", translation: "He has a stuffy nose." }
    ],
    152: [
      { text: "Cierra la *boca*, por favor.", translation: "Close your mouth, please." },
      { text: "Sonrió con toda la *boca*.", translation: "She smiled with her whole mouth." },
      { text: "No hables con la *boca* llena.", translation: "Don't talk with food in your mouth." }
    ],
    153: [
      { text: "Tiene el *pelo* largo y oscuro.", translation: "She has long, dark hair." },
      { text: "Se corta el *pelo* él mismo.", translation: "He cuts his own hair." },
      { text: "Mi *pelo* se moja con la lluvia.", translation: "My hair gets wet in the rain." }
    ],
    154: [
      { text: "Ponte la *chaqueta*, hace frío afuera.", translation: "Put on your jacket, it's cold outside." },
      { text: "Compré una *chaqueta* nueva ayer.", translation: "I bought a new jacket yesterday." },
      { text: "Su *chaqueta* es azul y calentita.", translation: "Her jacket is blue and warm." }
    ],
    155: [
      { text: "Quítate los *zapatos* antes de entrar.", translation: "Take off your shoes before you go in." },
      { text: "Estos *zapatos* son muy cómodos.", translation: "These shoes are very comfortable." },
      { text: "Necesito *zapatos* nuevos para el invierno.", translation: "I need new shoes for winter." }
    ],
    156: [
      { text: "Compré un *pantalón* nuevo ayer.", translation: "I bought new pants yesterday." },
      { text: "Mi *pantalón* es demasiado largo.", translation: "My pants are too long." },
      { text: "Siempre lleva *pantalón* negro.", translation: "He always wears black pants." }
    ],
    157: [
      { text: "Lleva una *camisa* blanca.", translation: "He's wearing a white shirt." },
      { text: "Mi *camisa* necesita plancharse.", translation: "My shirt needs ironing." },
      { text: "Le compramos una *camisa* nueva para su cumpleaños.", translation: "We bought him a new shirt for his birthday." }
    ],
    158: [
      { text: "Lleva un *vestido* bonito.", translation: "She's wearing a nice dress." },
      { text: "El *vestido* era rojo y largo.", translation: "The dress was red and long." },
      { text: "Voy a comprar un *vestido* nuevo para la fiesta.", translation: "I'm going to buy a new dress for the party." }
    ],
    159: [
      { text: "Ponte el *sombrero*, hace frío.", translation: "Put on your hat, it's cold." },
      { text: "Su *sombrero* es azul y calentito.", translation: "His hat is blue and warm." },
      { text: "Perdí mi *sombrero* con el viento.", translation: "I lost my hat in the wind." }
    ],
    160: [
      { text: "Llevo un *suéter* calentito.", translation: "I'm wearing a warm sweater." },
      { text: "Mi *suéter* es de lana.", translation: "My sweater is made of wool." },
      { text: "Me hizo un *suéter* tejido.", translation: "She knitted a sweater for me." }
    ],
    161: [
      { text: "Espera solo un *segundo*.", translation: "Just wait a second." },
      { text: "Solo tardó unos *segundos*.", translation: "It only took a few seconds." },
      { text: "Cada *segundo* cuenta.", translation: "Every second counts." }
    ],
    162: [
      { text: "La reunión duró una *hora*.", translation: "The meeting lasted an hour." },
      { text: "Espero una *hora* más.", translation: "I'll wait one more hour." },
      { text: "El viaje dura tres *horas*.", translation: "The trip takes three hours." }
    ],
    163: [
      { text: "Espera un *minuto*, por favor.", translation: "Wait a minute, please." },
      { text: "El tren llega en cinco *minutos*.", translation: "The train arrives in five minutes." },
      { text: "Solo tarda unos *minutos*.", translation: "It only takes a few minutes." }
    ],
    164: [
      { text: "Tengo veinte *años*.", translation: "I am twenty years old." },
      { text: "Nos mudamos aquí hace dos *años*.", translation: "We moved here two years ago." },
      { text: "El próximo *año* viajaremos a Italia.", translation: "Next year we're going to travel to Italy." }
    ],
    165: [
      { text: "¿Qué haces el *fin de semana*?", translation: "What are you doing this weekend?" },
      { text: "Vamos a la cabaña cada *fin de semana*.", translation: "We go to the cabin every weekend." },
      { text: "El *fin de semana* fue corto pero bonito.", translation: "The weekend was short but nice." }
    ],
    166: [
      { text: "El *lunes* empiezo un trabajo nuevo.", translation: "On Monday I start a new job." },
      { text: "Nos vemos cada *lunes*.", translation: "We meet every Monday." },
      { text: "El *lunes* fue agitado y largo.", translation: "Monday was busy and long." }
    ],
    167: [
      { text: "El *martes* tengo entrenamiento.", translation: "On Tuesday I have training." },
      { text: "Vamos a la ciudad el *martes*.", translation: "We're going to town on Tuesday." },
      { text: "Los *martes* son siempre tranquilos.", translation: "Tuesdays are always calm." }
    ],
    168: [
      { text: "La reunión es el *miércoles* a las diez.", translation: "The meeting is Wednesday at ten." },
      { text: "No trabaja los *miércoles*.", translation: "She doesn't work on Wednesdays." },
      { text: "Nos vemos de nuevo el *miércoles*.", translation: "We'll see each other again on Wednesday." }
    ],
    169: [
      { text: "El *jueves* cenamos juntos.", translation: "On Thursday we're having dinner together." },
      { text: "Vuelve a casa el *jueves*.", translation: "He travels home on Thursday." },
      { text: "Los *jueves* son mi día favorito.", translation: "Thursdays are my favorite day." }
    ],
    170: [
      { text: "¡Por fin es *viernes*!", translation: "Finally it's Friday!" },
      { text: "Siempre celebramos los *viernes*.", translation: "We always celebrate on Fridays." },
      { text: "El *viernes* por la noche salimos.", translation: "Friday evening we go out." }
    ],
    171: [
      { text: "Hacemos la compra los *sábados*.", translation: "We shop on Saturdays." },
      { text: "El *sábado* vamos a la playa.", translation: "On Saturday we're going to the beach." },
      { text: "La fiesta es el *sábado*.", translation: "The party is on Saturday." }
    ],
    172: [
      { text: "Comemos mucho los *domingos*.", translation: "We eat a big lunch on Sundays." },
      { text: "El *domingo* es un día tranquilo.", translation: "Sunday is a calm day." },
      { text: "La familia se reúne cada *domingo*.", translation: "The family gathers every Sunday." }
    ],
    173: [
      { text: "Las flores florecen en *primavera*.", translation: "The flowers bloom in spring." },
      { text: "La *primavera* es mi estación favorita.", translation: "Spring is my favorite season." },
      { text: "Plantamos verduras en *primavera*.", translation: "We plant vegetables in spring." }
    ],
    174: [
      { text: "Viajamos a Italia cada *verano*.", translation: "We travel to Italy every summer." },
      { text: "El *verano* fue cálido y soleado.", translation: "The summer was warm and sunny." },
      { text: "En *verano* nadamos cada día.", translation: "In summer we swim every day." }
    ],
    175: [
      { text: "Las hojas caen en *otoño*.", translation: "The leaves fall in autumn." },
      { text: "El *otoño* aquí es frío y húmedo.", translation: "Autumn is cold and wet here." },
      { text: "La escuela empieza en *otoño*.", translation: "School starts in autumn." }
    ],
    176: [
      { text: "Nieva mucho en *invierno*.", translation: "It snows a lot in winter." },
      { text: "El *invierno* es largo y frío aquí.", translation: "Winter is long and cold here." },
      { text: "Esquiamos en *invierno*.", translation: "We go skiing in winter." }
    ],
    177: [
      { text: "El *sol* brilla hoy.", translation: "The sun is shining today." },
      { text: "Tomamos el *sol* todo el día.", translation: "We sunbathed in the sun all day." },
      { text: "El *sol* se pone a las ocho.", translation: "The sun sets at eight." }
    ],
    178: [
      { text: "Hoy hay mucha *lluvia*.", translation: "There's a lot of rain today." },
      { text: "Nos mojamos con la *lluvia*.", translation: "We got wet from the rain." },
      { text: "La *lluvia* paró después de una hora.", translation: "The rain stopped after an hour." }
    ],
    179: [
      { text: "Hay mucha *nieve* en el suelo.", translation: "There's a lot of snow on the ground." },
      { text: "Los niños juegan en la *nieve*.", translation: "The children are playing in the snow." },
      { text: "La *nieve* se derritió rápido al sol.", translation: "The snow melted quickly in the sun." }
    ],
    180: [
      { text: "Hoy sopla mucho *viento*.", translation: "There's a lot of wind today." },
      { text: "El *viento* arrancó el tejado.", translation: "The wind ripped off the roof." },
      { text: "Sentimos un *viento* frío del mar.", translation: "We felt a cold wind from the sea." }
    ],
    181: [
      { text: "Hace un día *bonito* hoy.", translation: "The weather is nice today." },
      { text: "Estás *bonita* con ese vestido.", translation: "You look nice in that dress." },
      { text: "Fue *bonito* volver a verte.", translation: "It was nice to see you again." }
    ],
    182: [
      { text: "Hoy está *nublado*.", translation: "It's cloudy today." },
      { text: "El cielo se puso *nublado* por la tarde.", translation: "The sky became cloudy in the afternoon." },
      { text: "Tuvimos tiempo *nublado* toda la semana.", translation: "We had cloudy weather all week." }
    ],
    183: [
      { text: "El cielo está *claro* esta noche.", translation: "The sky is clear tonight." },
      { text: "El agua del lago es completamente *clara*.", translation: "The water in the lake is completely clear." },
      { text: "Mañana habrá tiempo *claro*.", translation: "There will be clear weather tomorrow." }
    ],
    184: [
      { text: "El tiempo ha estado *seco* todo el verano.", translation: "The weather has been dry all summer." },
      { text: "El suelo está *seco* después de muchos días sin lluvia.", translation: "The ground is dry after many days without rain." },
      { text: "La ropa está *seca* ahora.", translation: "The clothes are dry now." }
    ],
    185: [
      { text: "La hierba está *mojada* por la mañana.", translation: "The grass is wet in the morning." },
      { text: "Mis zapatos se *mojaron* con la lluvia.", translation: "My shoes got wet in the rain." },
      { text: "Su pelo estaba *mojado* después de la ducha.", translation: "Her hair was wet after the shower." }
    ],
    186: [
      { text: "Tomo el *tren* para ir al trabajo cada día.", translation: "I take the train to work every day." },
      { text: "El *tren* llegó tarde hoy.", translation: "The train was delayed today." },
      { text: "Viajamos en *tren* hasta Hamburgo.", translation: "We travelled by train to Hamburg." }
    ],
    187: [
      { text: "El *autobús* llega en diez minutos.", translation: "The bus arrives in ten minutes." },
      { text: "Tomo el *autobús* para ir a la escuela.", translation: "I take the bus to school." },
      { text: "Esperamos mucho tiempo el *autobús*.", translation: "We waited a long time for the bus." }
    ],
    188: [
      { text: "El *avión* despega a las diez.", translation: "The plane takes off at ten." },
      { text: "Viajamos en *avión* hasta España.", translation: "We travelled by plane to Spain." },
      { text: "El *avión* aterrizó de manera segura.", translation: "The plane landed safely." }
    ],
    189: [
      { text: "Tengo una *bicicleta* nueva.", translation: "I have a new bicycle." },
      { text: "Mi *bicicleta* está rota.", translation: "My bicycle is broken." },
      { text: "Va a la escuela en *bicicleta*.", translation: "He rides his bicycle to school." }
    ],
    190: [
      { text: "Tomamos un *barco* para cruzar el lago.", translation: "We took a boat across the lake." },
      { text: "El *barco* era pequeño pero rápido.", translation: "The boat was small but fast." },
      { text: "Pesca desde su *barco*.", translation: "He fishes from his boat." }
    ],
    191: [
      { text: "El tren se detiene en esta *estación*.", translation: "The train stops at this station." },
      { text: "Nos vimos en la *estación*.", translation: "We met at the station." },
      { text: "La *estación* está en el centro de la ciudad.", translation: "The station is in the middle of the city." }
    ],
    192: [
      { text: "Fuimos temprano al *aeropuerto*.", translation: "We drove to the airport early." },
      { text: "El *aeropuerto* estaba lleno de gente.", translation: "The airport was full of people." },
      { text: "Trabaja en el *aeropuerto*.", translation: "He works at the airport." }
    ],
    193: [
      { text: "Compré un *billete* para el concierto.", translation: "I bought a ticket to the concert." },
      { text: "¿Puedo ver tu *billete*?", translation: "Can I see your ticket?" },
      { text: "Necesitamos dos *billetes* para el tren.", translation: "We need two tickets for the train." }
    ],
    194: [
      { text: "¿Puedes mostrarme en el *mapa*?", translation: "Can you show me on the map?" },
      { text: "Usamos un *mapa* para encontrar el camino.", translation: "We used a map to find the way." },
      { text: "El *mapa* muestra toda la ciudad.", translation: "The map shows the whole city." }
    ],
    195: [
      { text: "Nos alojamos en un *hotel* bonito.", translation: "We're staying at a nice hotel." },
      { text: "El *hotel* está cerca de la playa.", translation: "The hotel is near the beach." },
      { text: "La habitación del *hotel* era grande.", translation: "The room at the hotel was big." }
    ],
    196: [
      { text: "Gira a la *izquierda* en el semáforo.", translation: "Turn left at the traffic light." },
      { text: "El libro está en el lado *izquierdo* de la mesa.", translation: "The book is on the left side of the table." },
      { text: "Escribe con la mano *izquierda*.", translation: "He writes with his left hand." }
    ],
    197: [
      { text: "Gira a la *derecha* después del puente.", translation: "Turn right after the bridge." },
      { text: "La tienda está en el lado *derecho* de la calle.", translation: "The shop is on the right side of the street." },
      { text: "Sostiene el bolígrafo en la mano *derecha*.", translation: "She holds the pen in her right hand." }
    ],
    198: [
      { text: "Ve *todo recto* hasta que veas la escuela.", translation: "Go straight ahead until you see the school." },
      { text: "Conduce *todo recto* durante dos kilómetros.", translation: "Drive straight ahead for two kilometers." },
      { text: "La estación está *todo recto*, no lejos de aquí.", translation: "The station is straight ahead, not far from here." }
    ],
    199: [
      { text: "Vivimos *cerca* de la escuela.", translation: "We live near the school." },
      { text: "La tienda está *cerca* de nuestra casa.", translation: "The shop is near our house." },
      { text: "Vive *cerca* de mí.", translation: "He lives near me." }
    ],
    200: [
    ...
    251: [
      { text: "Hoy estoy muy *feliz*.", translation: "I'm very happy today." },
      { text: "Estaba *feliz* por el regalo.", translation: "She was happy about the gift." },
      { text: "Estamos *felices* de verte.", translation: "We're happy to see you." }
    ],
    252: [
      { text: "Está *triste* porque su perro está enfermo.", translation: "He's sad because his dog is sick." },
      { text: "La película me puso *triste*.", translation: "The movie made me sad." },
      { text: "Nos sentimos *tristes* después de la noticia.", translation: "We felt sad after the news." }
    ],
    253: [
      { text: "Se puso *enfadada* cuando él llegó tarde.", translation: "She got angry when he came late." },
      { text: "No estés *enfadado* conmigo.", translation: "Don't be angry with me." },
      { text: "Estuvo *enfadado* todo el día.", translation: "He was angry all day." }
    ],
    254: [
      { text: "Estoy muy *cansado* esta noche.", translation: "I'm very tired tonight." },
      { text: "Se puso *cansada* después del trabajo.", translation: "She got tired after work." },
      { text: "Estábamos *cansados* después del largo viaje.", translation: "We were tired after the long trip." }
    ],
    255: [
      { text: "Estoy *enfermo* hoy y me quedo en casa.", translation: "I'm sick today and staying home." },
      { text: "El niño está *enfermo* y tiene fiebre.", translation: "The child is sick and has a fever." },
      { text: "Estuvo *enferma* toda la semana.", translation: "She was sick all week." }
    ],
    256: [
      { text: "El examen fue *fácil*.", translation: "The test was easy." },
      { text: "Esta es una tarea *fácil*.", translation: "This is an easy task." },
      { text: "Fue *fácil* encontrar el camino.", translation: "It was easy to find the way." }
    ],
    257: [
      { text: "Esta tarea es *difícil*.", translation: "This task is difficult." },
      { text: "Fue *difícil* entenderlo.", translation: "It was difficult to understand him." },
      { text: "El español no es tan *difícil* de aprender.", translation: "Spanish isn't so difficult to learn." }
    ],
    258: [
      { text: "Este coche es muy *caro*.", translation: "This car is very expensive." },
      { text: "El hotel era *caro*.", translation: "The hotel was expensive." },
      { text: "Encontramos un restaurante *caro* pero bonito.", translation: "We found an expensive but nice restaurant." }
    ],
    259: [
      { text: "Este suéter era *barato*.", translation: "This sweater was cheap." },
      { text: "Buscábamos un hotel *barato*.", translation: "We looked for a cheap hotel." },
      { text: "El billete de avión era sorprendentemente *barato*.", translation: "The plane ticket was surprisingly cheap." }
    ],
    260: [
      { text: "La entrada es *gratis* hoy.", translation: "Entry is free today." },
      { text: "El café en la oficina es *gratis*.", translation: "The coffee at the office is free." },
      { text: "El museo es *gratis* para niños.", translation: "The museum is free for children." }
    ],
    261: [
      { text: "Tenemos *muchos* amigos aquí.", translation: "We have many friends here." },
      { text: "Había *mucha* gente en la fiesta.", translation: "There were many people at the party." },
      { text: "Ha leído *muchos* libros.", translation: "She has read many books." }
    ],
    262: [
      { text: "Había *pocos* visitantes en el museo hoy.", translation: "There were few people at the museum today." },
      { text: "Nos quedan *pocos* días de vacaciones.", translation: "We have few days left of the holiday." },
      { text: "Solo vinieron *pocos* estudiantes a clase.", translation: "Only a few students came to class." }
    ],
    263: [
      { text: "¿Puedo tomar *más* café?", translation: "Can I have more coffee?" },
      { text: "Necesito *más* tiempo.", translation: "I need more time." },
      { text: "Habla *más* que su hermano.", translation: "She talks more than her brother." }
    ],
    264: [
      { text: "Ahora como *menos* carne.", translation: "I eat less meat now." },
      { text: "Tenemos *menos* tiempo del que pensábamos.", translation: "We have less time than we thought." },
      { text: "Trabaja *menos* que antes.", translation: "He works less than before." }
    ],
    265: [
      { text: "¿Tenemos comida *suficiente* para todos?", translation: "Do we have enough food for everyone?" },
      { text: "No tengo dinero *suficiente*.", translation: "I don't have enough money." },
      { text: "Hay espacio *suficiente* en el coche.", translation: "There's enough room in the car." }
    ],
    266: [
      { text: "Viajo *a menudo* a España.", translation: "I often travel to Spain." },
      { text: "Llama *a menudo* a sus padres.", translation: "She often calls her parents." },
      { text: "Comemos *a menudo* pescado en la cena.", translation: "We often eat fish for dinner." }
    ],
    267: [
      { text: "*Nunca* bebo café por la noche.", translation: "I never drink coffee in the evening." },
      { text: "*Nunca* llega tarde.", translation: "He never comes late." },
      { text: "*Nunca* hemos estado en Japón.", translation: "We have never been to Japan." }
    ],
    268: [
      { text: "*A veces* doy un paseo solo.", translation: "I sometimes go for a walk alone." },
      { text: "*A veces* desayuna tarde.", translation: "She sometimes eats breakfast late." },
      { text: "*A veces* vamos a la cabaña el fin de semana.", translation: "We sometimes go to the cabin on weekends." }
    ],
    269: [
      { text: "Me despierto *temprano* cada día.", translation: "I wake up early every day." },
      { text: "Llegamos *temprano* al aeropuerto.", translation: "We arrived early at the airport." },
      { text: "La reunión empieza *temprano* mañana.", translation: "The meeting starts early tomorrow." }
    ],
    270: [
      { text: "Hoy llegó *tarde* al trabajo.", translation: "He came late to work today." },
      { text: "Cenamos *tarde* ayer.", translation: "We ate dinner late yesterday." },
      { text: "El tren salió *tarde* por la noche.", translation: "The train left late in the evening." }
    ],
    271: [
      { text: "*Este* libro es muy bueno.", translation: "This book is very good." },
      { text: "Me gusta *este* suéter.", translation: "I like this sweater." },
      { text: "*Esta* semana ha sido agitada.", translation: "This week has been busy." }
    ],
    272: [
      { text: "*Esta* casa es grande.", translation: "This house is big." },
      { text: "No entiendo *esta* palabra.", translation: "I don't understand this word." },
      { text: "*Este* es mi hermano.", translation: "This is my brother." }
    ],
    273: [
      { text: "*Estos* zapatos son nuevos.", translation: "These shoes are new." },
      { text: "Me gustan *estas* fotos.", translation: "I like these pictures." },
      { text: "*Estos* libros son de la biblioteca.", translation: "These books are from the library." }
    ],
    274: [
      { text: "Vivimos en la *misma* ciudad.", translation: "We live in the same city." },
      { text: "Tiene la *misma* chaqueta que yo.", translation: "He has the same jacket as me." },
      { text: "Fueron a la *misma* escuela.", translation: "They went to the same school." }
    ],
    275: [
      { text: "Prefiero el *otro* libro.", translation: "I'd rather have the other book." },
      { text: "Tomamos el *otro* camino.", translation: "We'll take the other way." },
      { text: "Vive en el *otro* lado de la calle.", translation: "She lives on the other side of the street." }
    ],
    276: [
      { text: "¡*Adiós*! Nos vemos mañana.", translation: "Bye! See you tomorrow." },
      { text: "Saludó con la mano y dijo *adiós*.", translation: "She waved and said bye." },
      { text: "¡*Adiós*, hablamos pronto!", translation: "Bye, talk soon!" }
    ],
    277: [
      { text: "¡*Buenos días*! ¿Dormiste bien?", translation: "Good morning! Did you sleep well?" },
      { text: "Dijo *buenos días* a todos en la oficina.", translation: "He said good morning to everyone at the office." },
      { text: "*Buenos días*, hoy hace un día bonito.", translation: "Good morning, it's a nice day today." }
    ],
    278: [
      { text: "¡*Buenas tardes*! ¿Cómo estás?", translation: "Good evening! How are you?" },
      { text: "Dijimos *buenas tardes* y entramos.", translation: "We said good evening and went in." },
      { text: "*Buenas tardes*, bienvenidos al restaurante.", translation: "Good evening, welcome to the restaurant." }
    ],
    279: [
      { text: "¡*Buenas noches*, que duermas bien!", translation: "Good night, sleep well!" },
      { text: "Dijo *buenas noches* a los niños.", translation: "She said good night to the children." },
      { text: "*Buenas noches*, nos vemos temprano mañana.", translation: "Good night, see you early tomorrow." }
    ],
    280: [
      { text: "¡*Bienvenido* a España!", translation: "Welcome to Spain!" },
      { text: "Siempre eres *bienvenido* en nuestra casa.", translation: "You're always welcome at our home." },
      { text: "*Bienvenido*, ¡pasa!", translation: "Welcome, come in!" }
    ],
    281: [
      { text: "*Aquí tienes*, aquí está tu café.", translation: "Here you are, here's your coffee." },
      { text: "*Aquí tienes*, siéntate.", translation: "Please, sit down." },
      { text: "Me dio el libro y dijo *aquí tienes*.", translation: "She gave me the book and said here you are." }
    ],
    282: [
      { text: "¡*Muchas gracias* por la ayuda!", translation: "Many thanks for the help!" },
      { text: "*Muchas gracias*, fue muy amable de tu parte.", translation: "Thank you so much, that was very kind of you." },
      { text: "Dijimos *muchas gracias* y nos fuimos a casa.", translation: "We said thanks a lot and went home." }
    ],
    283: [
      { text: "*Está bien*, no te preocupes.", translation: "It's fine, don't worry." },
      { text: "¿Cómo va todo? *Está bien*, gracias.", translation: "How's it going? It's fine, thanks." },
      { text: "Todo *está bien* conmigo ahora.", translation: "I'm doing fine now." }
    ],
    284: [
      { text: "Fue una buena película, ¿*verdad*?", translation: "That was a nice movie, right?" },
      { text: "Te gusta el café, ¿*verdad*?", translation: "You like coffee, right?" },
      { text: "Nos conocimos el año pasado, ¿*verdad*?", translation: "We met last year, right?" }
    ],
    285: [
      { text: "*Por supuesto* que puedo ayudarte.", translation: "Of course I can help you." },
      { text: "¿Vienes esta noche? ¡*Por supuesto*!", translation: "Are you coming tonight? Of course!" },
      { text: "*Por supuesto* que me acuerdo de ti.", translation: "Of course I remember you." }
    ],
    286: [
      { text: "Tengo que ir a la *farmacia* a comprar medicina.", translation: "I need to go to the pharmacy and buy medicine." },
      { text: "La *farmacia* está al lado de la tienda.", translation: "The pharmacy is next to the shop." },
      { text: "La *farmacia* abre a las ocho.", translation: "The pharmacy opens at eight." }
    ],
    287: [
      { text: "Lo llevaron al *hospital* ayer.", translation: "He was taken to the hospital yesterday." },
      { text: "El *hospital* está fuera de la ciudad.", translation: "The hospital is outside the city." },
      { text: "Trabaja en el *hospital* como enfermera.", translation: "She works at the hospital as a nurse." }
    ],
    288: [
      { text: "Tengo cita con el *dentista* mañana.", translation: "I have an appointment with the dentist tomorrow." },
      { text: "El *dentista* revisó mis dientes.", translation: "The dentist checked my teeth." },
      { text: "Los niños deberían ir al *dentista* cada año.", translation: "Children should go to the dentist every year." }
    ],
    289: [
      { text: "¿Puedo tener un poco de *ayuda*?", translation: "Can I get some help?" },
      { text: "¡Muchas gracias por la *ayuda*!", translation: "Thanks a lot for the help!" },
      { text: "Necesitaba *ayuda* con los deberes.", translation: "She needed help with the homework." }
    ],
    290: [
      { text: "Tenemos un pequeño *problema*.", translation: "We have a small problem." },
      { text: "El *problema* se resolvió rápido.", translation: "The problem was solved quickly." },
      { text: "No hay *problema*, puedo ayudar.", translation: "No problem, I can help." }
    ],
    291: [
      { text: "¿Cuál es el *precio* de este suéter?", translation: "What's the price of this sweater?" },
      { text: "El *precio* era más alto de lo que esperaba.", translation: "The price was higher than I expected." },
      { text: "Comparamos *precios* en varias tiendas.", translation: "We compared prices in several shops." }
    ],
    292: [
      { text: "Hoy no tengo *dinero* suficiente.", translation: "I don't have enough money today." },
      { text: "Está ahorrando *dinero* para el viaje.", translation: "She's saving money for the trip." },
      { text: "Necesitamos más *dinero* para el proyecto.", translation: "We need more money for the project." }
    ],
    293: [
      { text: "¿Puedo tener un *recibo*, por favor?", translation: "Can I have a receipt, please?" },
      { text: "Perdí mi *recibo*.", translation: "I lost my receipt." },
      { text: "El *recibo* muestra lo que pagaste.", translation: "The receipt shows what you paid." }
    ],
    294: [
      { text: "¿Necesitas una *bolsa*?", translation: "Do you need a bag?" },
      { text: "La *bolsa* estaba llena de verduras.", translation: "The bag was full of vegetables." },
      { text: "Olvidé mis *bolsas* en casa.", translation: "I forgot my bags at home." }
    ],
    295: [
      { text: "¿Qué *talla* usas?", translation: "What size do you wear?" },
      { text: "Este suéter es la *talla* equivocada.", translation: "This sweater is the wrong size." },
      { text: "Tienen todas las *tallas* en esta tienda.", translation: "They have all sizes in this shop." }
    ],
    296: [
      { text: "Olvidé mi *teléfono* en casa.", translation: "I forgot my phone at home." },
      { text: "El *teléfono* sonó en medio de la noche.", translation: "The phone rang in the middle of the night." },
      { text: "¿Puedo pedir prestado tu *teléfono*?", translation: "Can I borrow your phone?" }
    ],
    297: [
      { text: "Mi *ordenador* es muy viejo.", translation: "My computer is very old." },
      { text: "El *ordenador* dejó de funcionar ayer.", translation: "The computer stopped working yesterday." },
      { text: "Trabajo en el *ordenador* todo el día.", translation: "I work on the computer all day." }
    ],
    298: [
      { text: "He perdido mi *llave*.", translation: "I've lost my key." },
      { text: "La *llave* está debajo del felpudo.", translation: "The key is under the mat." },
      { text: "¿Puedes darme las *llaves*?", translation: "Can you give me the keys?" }
    ],
    299: [
      { text: "El *reloj* en la pared muestra la hora equivocada.", translation: "The clock on the wall shows the wrong time." },
      { text: "Compré un *reloj* nuevo ayer.", translation: "I bought a new watch yesterday." },
      { text: "El *reloj* sonó a las siete.", translation: "The clock rang at seven." }
    ],
    300: [
    ...
    351: [
      { text: "La comida está en la *mesa*.", translation: "The food is on the table." },
      { text: "Compramos una *mesa* nueva para la sala.", translation: "We bought a new table for the living room." },
      { text: "Siéntate en la *mesa*.", translation: "Sit down at the table." }
    ],
    352: [
      { text: "Esta *silla* es muy cómoda.", translation: "This chair is very comfortable." },
      { text: "¿Puedes traerme una *silla*?", translation: "Can you get me a chair?" },
      { text: "Necesitamos más *sillas* para la cena.", translation: "We need more chairs for the dinner." }
    ],
    353: [
      { text: "Voy a la *cama* a las diez.", translation: "I get into bed at ten." },
      { text: "Mi *cama* es muy suave.", translation: "My bed is very soft." },
      { text: "El niño duerme en una *cama* pequeña.", translation: "The child sleeps in a small bed." }
    ],
    354: [
      { text: "¿Puedes cerrar la *puerta*?", translation: "Can you close the door?" },
      { text: "La *puerta* estaba cerrada con llave.", translation: "The door was locked." },
      { text: "Llamó a la *puerta*.", translation: "He knocked on the door." }
    ],
    355: [
      { text: "¿Puedes abrir la *ventana*?", translation: "Can you open the window?" },
      { text: "La *ventana* estaba sucia.", translation: "The window was dirty." },
      { text: "El sol entraba por la *ventana*.", translation: "The sun shone in through the window." }
    ],
    356: [
      { text: "El cuadro está colgado en la *pared*.", translation: "The picture hangs on the wall." },
      { text: "La *pared* está pintada de blanco.", translation: "The wall is painted white." },
      { text: "Pusimos un estante en la *pared*.", translation: "We attached a shelf to the wall." }
    ],
    357: [
      { text: "El *suelo* está frío en invierno.", translation: "The floor is cold in winter." },
      { text: "Fregó el *suelo* ayer.", translation: "She washed the floor yesterday." },
      { text: "El niño juega en el *suelo*.", translation: "The child is playing on the floor." }
    ],
    358: [
      { text: "El *techo* gotea cuando llueve.", translation: "The roof leaks when it rains." },
      { text: "Pintamos el *techo* en verano.", translation: "We painted the roof this summer." },
      { text: "La nieve cubría todo el *techo*.", translation: "The snow covered the whole roof." }
    ],
    359: [
      { text: "Cultivamos verduras en el *jardín*.", translation: "We grow vegetables in the garden." },
      { text: "Nuestro *jardín* está lleno de flores.", translation: "Our garden is full of flowers." },
      { text: "Los niños juegan en el *jardín* cada día.", translation: "The children play in the garden every day." }
    ],
    360: [
      { text: "El coche está en el *garaje*.", translation: "The car is in the garage." },
      { text: "Construimos un *garaje* nuevo el año pasado.", translation: "We built a new garage last year." },
      { text: "El *garaje* está lleno de herramientas.", translation: "The garage is full of tools." }
    ],
    361: [
      { text: "La *lámpara* de la sala es muy bonita.", translation: "The lamp in the living room is very nice." },
      { text: "¿Puedes encender la *lámpara*?", translation: "Can you turn on the lamp?" },
      { text: "Compramos una *lámpara* nueva para el dormitorio.", translation: "We bought a new lamp for the bedroom." }
    ],
    362: [
      { text: "Se mira en el *espejo*.", translation: "She looks at herself in the mirror." },
      { text: "El *espejo* del baño es grande.", translation: "The mirror in the bathroom is big." },
      { text: "Colgamos un *espejo* nuevo en el pasillo.", translation: "We hung up a new mirror in the hallway." }
    ],
    363: [
      { text: "¿Puedes darme una *toalla*?", translation: "Can you give me a towel?" },
      { text: "La *toalla* estaba mojada.", translation: "The towel was wet." },
      { text: "Lavamos las *toallas* cada semana.", translation: "We wash the towels every week." }
    ],
    364: [
      { text: "Lávate las manos con *jabón*.", translation: "Wash your hands with soap." },
      { text: "El *jabón* olía a lavanda.", translation: "The soap smelled like lavender." },
      { text: "Necesitamos más *jabón* en el baño.", translation: "We need more soap in the bathroom." }
    ],
    365: [
      { text: "La leche está en la *nevera*.", translation: "The milk is in the fridge." },
      { text: "Nuestra *nevera* está casi vacía.", translation: "Our fridge is almost empty." },
      { text: "Compramos una *nevera* nueva ayer.", translation: "We bought a new fridge yesterday." }
    ],
    366: [
      { text: "El pan está en el *horno*.", translation: "The bread is in the oven." },
      { text: "El *horno* está muy caliente ahora.", translation: "The oven is very hot now." },
      { text: "Puso el pastel en el *horno*.", translation: "She put the cake in the oven." }
    ],
    367: [
      { text: "Nos sentamos en el *sofá* a ver la tele.", translation: "We're sitting on the sofa watching TV." },
      { text: "El *sofá* es suave y cómodo.", translation: "The sofa is soft and comfortable." },
      { text: "El gato siempre duerme en el *sofá*.", translation: "The cat always sleeps on the sofa." }
    ],
    368: [
      { text: "El libro está en el *estante*.", translation: "The book is on the shelf." },
      { text: "Necesitamos un *estante* nuevo para la cocina.", translation: "We need a new shelf for the kitchen." },
      { text: "El *estante* está lleno de libros.", translation: "The shelf is full of books." }
    ],
    369: [
      { text: "Subió corriendo la *escalera*.", translation: "He ran up the stairs." },
      { text: "La *escalera* es empinada y estrecha.", translation: "The stairs are steep and narrow." },
      { text: "Ten cuidado en la *escalera*.", translation: "Be careful on the stairs." }
    ],
    370: [
      { text: "Tomamos el *ascensor* hasta el quinto piso.", translation: "We took the elevator up to the fifth floor." },
      { text: "El *ascensor* estaba roto hoy.", translation: "The elevator was broken today." },
      { text: "Tiene miedo de tomar el *ascensor*.", translation: "He's afraid of taking the elevator." }
    ],
    371: [
      { text: "Tenemos un *perro* que se llama Rex.", translation: "We have a dog named Rex." },
      { text: "El *perro* corría detrás de la pelota.", translation: "The dog ran after the ball." },
      { text: "Saca al *perro* cada mañana.", translation: "He walks the dog every morning." }
    ],
    372: [
      { text: "El *gato* duerme todo el día.", translation: "The cat sleeps all day." },
      { text: "Adoptamos un *gato* el año pasado.", translation: "We adopted a cat last year." },
      { text: "Nuestro *gato* es blanco y negro.", translation: "Our cat is black and white." }
    ],
    373: [
      { text: "Escuché un *pájaro* cantar afuera.", translation: "I heard a bird singing outside." },
      { text: "El *pájaro* voló rápido.", translation: "The bird flew away quickly." },
      { text: "Vimos muchos *pájaros* en el parque.", translation: "We saw many birds in the park." }
    ],
    374: [
      { text: "Monta a *caballo* cada fin de semana.", translation: "She rides a horse every weekend." },
      { text: "El *caballo* corría rápido por el campo.", translation: "The horse ran fast across the field." },
      { text: "Vimos *caballos* en la granja.", translation: "We saw horses at the farm." }
    ],
    375: [
      { text: "El granjero tiene muchas *vacas*.", translation: "The farmer has many cows." },
      { text: "La *vaca* pastaba en el campo.", translation: "The cow grazed in the field." },
      { text: "Vimos *vacas* por el camino.", translation: "We saw cows along the road." }
    ],
    376: [
      { text: "Hay muchas *ovejas* en la montaña.", translation: "There are many sheep in the mountains." },
      { text: "La *oveja* tenía lana blanca.", translation: "The sheep had white wool." },
      { text: "El granjero esquila las *ovejas* en primavera.", translation: "The farmer shears the sheep in spring." }
    ],
    377: [
      { text: "El granjero tiene cinco *cerdos*.", translation: "The farmer has five pigs." },
      { text: "El *cerdo* era rosa y sucio.", translation: "The pig was pink and dirty." },
      { text: "Vimos *cerdos* en la visita a la granja.", translation: "We saw pigs on the farm visit." }
    ],
    378: [
      { text: "La *gallina* ponía huevos cada día.", translation: "The hen laid eggs every day." },
      { text: "Tenemos cinco *gallinas* en el jardín.", translation: "We have five hens in the garden." },
      { text: "Las *gallinas* corrían por el corral.", translation: "The hens ran around the farmyard." }
    ],
    379: [
      { text: "Hay un *ratón* en la cocina.", translation: "There's a mouse in the kitchen." },
      { text: "El gato persiguió al *ratón*.", translation: "The cat chased the mouse." },
      { text: "Vimos un *ratón* pequeño pasar corriendo.", translation: "We saw a small mouse run by." }
    ],
    380: [
      { text: "Los niños tienen un *conejo* de mascota.", translation: "The children have a rabbit as a pet." },
      { text: "El *conejo* comía zanahorias.", translation: "The rabbit ate carrots." },
      { text: "Vimos un *conejo* salvaje en el jardín.", translation: "We saw a wild rabbit in the garden." }
    ],
    381: [
      { text: "Plantamos un *árbol* en el jardín.", translation: "We planted a tree in the garden." },
      { text: "El *árbol* es muy alto.", translation: "The tree is very tall." },
      { text: "Los pájaros hicieron un nido en el *árbol*.", translation: "The birds built a nest in the tree." }
    ],
    382: [
      { text: "Me regaló una *flor*.", translation: "She gave me a flower." },
      { text: "Las *flores* del jardín son preciosas.", translation: "The flowers in the garden are beautiful." },
      { text: "Plantamos *flores* nuevas en primavera.", translation: "We planted new flowers in spring." }
    ],
    383: [
      { text: "La *hierba* está verde en verano.", translation: "The grass is green in summer." },
      { text: "Los niños juegan en la *hierba*.", translation: "The children are playing on the grass." },
      { text: "Cortamos la *hierba* cada semana.", translation: "We mow the grass every week." }
    ],
    384: [
      { text: "Ayer subimos la *montaña*.", translation: "We climbed the mountain yesterday." },
      { text: "La *montaña* estaba cubierta de nieve.", translation: "The mountain was covered in snow." },
      { text: "La vista desde la *montaña* era fantástica.", translation: "The view from the mountain was fantastic." }
    ],
    385: [
      { text: "El *río* atraviesa la ciudad.", translation: "The river runs through the city." },
      { text: "Pescamos en el *río* ayer.", translation: "We fished in the river yesterday." },
      { text: "Los niños nadaban en el *río*.", translation: "The children swam in the river." }
    ],
    386: [
      { text: "Vivimos cerca del *mar*.", translation: "We live near the sea." },
      { text: "El *mar* estaba tranquilo hoy.", translation: "The sea was calm today." },
      { text: "Navegaron por el *mar*.", translation: "They sailed across the sea." }
    ],
    387: [
      { text: "Nadamos en el *lago* en verano.", translation: "We swim in the lake in summer." },
      { text: "El *lago* estaba quieto y claro.", translation: "The lake was calm and clear." },
      { text: "La cabaña está junto a un *lago* pequeño.", translation: "The cabin is by a small lake." }
    ],
    388: [
      { text: "Dimos un paseo por el *bosque*.", translation: "We went for a walk in the forest." },
      { text: "El *bosque* estaba lleno de árboles y pájaros.", translation: "The forest was full of trees and birds." },
      { text: "Los niños recogieron setas en el *bosque*.", translation: "The children picked mushrooms in the forest." }
    ],
    389: [
      { text: "Pasamos todo el día en la *playa*.", translation: "We spent the whole day at the beach." },
      { text: "La *playa* estaba llena de gente.", translation: "The beach was full of people." },
      { text: "Los niños construyeron castillos de arena en la *playa*.", translation: "The children built sandcastles on the beach." }
    ],
    390: [
      { text: "El *cielo* está azul hoy.", translation: "The sky is blue today." },
      { text: "Vimos las estrellas en el *cielo*.", translation: "We saw the stars in the sky." },
      { text: "El *cielo* se puso rojo al atardecer.", translation: "The sky turned red at sunset." }
    ],
    391: [
      { text: "Tiene *treinta* años.", translation: "She's thirty years old." },
      { text: "Esperamos *treinta* minutos.", translation: "We waited thirty minutes." },
      { text: "Abril tiene *treinta* días.", translation: "April has thirty days." }
    ],
    392: [
      { text: "Tiene *cuarenta* años.", translation: "He's forty years old." },
      { text: "Condujimos durante *cuarenta* minutos.", translation: "We drove for forty minutes." },
      { text: "El billete costaba *cuarenta* euros.", translation: "The ticket cost forty euros." }
    ],
    393: [
      { text: "La abuela tiene *cincuenta* años.", translation: "Grandmother is fifty years old." },
      { text: "Esperamos *cincuenta* minutos el avión.", translation: "We waited fifty minutes for the plane." },
      { text: "Había *cincuenta* invitados en la boda.", translation: "There were fifty guests at the wedding." }
    ],
    394: [
      { text: "Han pasado *cien* años desde que se construyó la casa.", translation: "It's a hundred years since the house was built." },
      { text: "Pagamos *cien* euros por el billete.", translation: "We paid a hundred euros for the ticket." },
      { text: "Había *cien* personas en el concierto.", translation: "There were a hundred people at the concert." }
    ],
    395: [
      { text: "La ciudad tiene más de *mil* habitantes.", translation: "The town has over a thousand inhabitants." },
      { text: "Pagamos *mil* euros por el viaje.", translation: "We paid a thousand euros for the trip." },
      { text: "Había *mil* estrellas en el cielo.", translation: "There were a thousand stars in the sky." }
    ],
    396: [
      { text: "El cielo está *gris* hoy.", translation: "The sky is grey today." },
      { text: "Tiene un coche *gris*.", translation: "He has a grey car." },
      { text: "Su gato es *gris* y blanco.", translation: "Her cat is grey and white." }
    ],
    397: [
      { text: "Este es mi *primer* día de trabajo.", translation: "This is my first day at work." },
      { text: "Vivimos en el *primer* piso.", translation: "We live on the first floor." },
      { text: "Llegó *primera* en la carrera.", translation: "She came first in the race." }
    ],
    398: [
      { text: "Este es el *último* día de vacaciones.", translation: "This is the last day of the holiday." },
      { text: "Fue el *último* en irse.", translation: "He was the last one to leave." },
      { text: "Era la *última* manzana en la cesta.", translation: "It was the last apple in the basket." }
    ],
    399: [
      { text: "Dividimos el pastel en dos *mitades*.", translation: "We divided the cake into two halves." },
      { text: "Solo comí *mitad* de la manzana.", translation: "I only ate half of the apple." },
      { text: "La segunda *mitad* de la película fue mejor.", translation: "The second half of the movie was better." }
    ],
    400: [
    ...
    451: [
      { text: "Siempre pago en *efectivo*.", translation: "I always pay with cash." },
      { text: "¿Tienes *efectivo* contigo?", translation: "Do you have cash on you?" },
      { text: "La tienda ya no acepta *efectivo*.", translation: "The shop no longer accepts cash." }
    ],
    452: [
      { text: "Pagué con *tarjeta de crédito*.", translation: "I paid with credit card." },
      { text: "Mi *tarjeta de crédito* fue rechazada.", translation: "My credit card was declined." },
      { text: "¿Puedo usar *tarjeta de crédito* aquí?", translation: "Can I use a credit card here?" }
    ],
    453: [
      { text: "Tuvimos un *descuento* en el hotel.", translation: "We got a discount on the hotel." },
      { text: "El *descuento* era del veinte por ciento.", translation: "The discount was twenty percent." },
      { text: "La tienda daba *descuento* a los estudiantes.", translation: "The shop gave a discount to students." }
    ],
    454: [
      { text: "Es un *cliente* fiel.", translation: "He's a loyal customer." },
      { text: "El *cliente* se quejó del precio.", translation: "The customer complained about the price." },
      { text: "Tenemos muchos *clientes* nuevos este año.", translation: "We have many new customers this year." }
    ],
    455: [
      { text: "Me hizo un bonito *regalo*.", translation: "She gave me a nice gift." },
      { text: "El *regalo* estaba envuelto en papel rojo.", translation: "The gift was wrapped in red paper." },
      { text: "Compramos un *regalo* para su cumpleaños.", translation: "We bought a gift for his birthday." }
    ],
    456: [
      { text: "Me encanta escuchar *música*.", translation: "I love listening to music." },
      { text: "La *música* en la fiesta era fantástica.", translation: "The music at the party was fantastic." },
      { text: "Toca *música* clásica.", translation: "She plays classical music." }
    ],
    457: [
      { text: "Esta *canción* es mi favorita.", translation: "This song is my favorite." },
      { text: "Cantamos juntos una *canción* antigua.", translation: "We sang an old song together." },
      { text: "La *canción* habla de amor.", translation: "The song is about love." }
    ],
    458: [
      { text: "Ayer vimos una *película* emocionante.", translation: "We watched an exciting film yesterday." },
      { text: "La *película* duró dos horas.", translation: "The film lasted two hours." },
      { text: "¿Qué *película* quieres ver esta noche?", translation: "Which film do you want to watch tonight?" }
    ],
    459: [
      { text: "Los niños juegan un *juego* divertido.", translation: "The children are playing a fun game." },
      { text: "El *juego* duró toda la noche.", translation: "The game lasted all evening." },
      { text: "Compramos un *juego* nuevo para su cumpleaños.", translation: "We bought a new game for his birthday." }
    ],
    460: [
      { text: "Vamos a hacer una *fiesta* el sábado.", translation: "We're having a party on Saturday." },
      { text: "La *fiesta* fue muy bonita.", translation: "The party was very nice." },
      { text: "Invitó a todos sus amigos a la *fiesta*.", translation: "She invited all her friends to the party." }
    ],
    461: [
      { text: "Juega al *fútbol* cada fin de semana.", translation: "He plays football every weekend." },
      { text: "El *fútbol* es el deporte más popular aquí.", translation: "Football is the most popular sport here." },
      { text: "El chico sueña con ser profesional en el *fútbol*.", translation: "The boy dreams of becoming a professional in football." }
    ],
    462: [
      { text: "Jugamos al *tenis* cada martes.", translation: "We play tennis every Tuesday." },
      { text: "Es muy buena en el *tenis*.", translation: "She's very good at tennis." },
      { text: "Aprendió a jugar al *tenis* de niño.", translation: "He learned tennis as a child." }
    ],
    463: [
      { text: "Le gustan todos los *deportes*.", translation: "He likes all kinds of sport." },
      { text: "El *deporte* es importante para la salud.", translation: "Sport is important for health." },
      { text: "¿Qué *deporte* practicas?", translation: "What sport do you do?" }
    ],
    464: [
      { text: "Nuestro *equipo* ganó el partido ayer.", translation: "Our team won the match yesterday." },
      { text: "Juega para un *equipo* local.", translation: "She plays for a local team." },
      { text: "El *equipo* entrenaba cada día antes del campeonato.", translation: "The team trained every day before the championship." }
    ],
    465: [
      { text: "El niño tiró la *pelota* por encima de la valla.", translation: "The child threw the ball over the fence." },
      { text: "Jugábamos con una *pelota* roja.", translation: "We played with a red ball." },
      { text: "La *pelota* golpeó la ventana.", translation: "The ball hit the window." }
    ],
    466: [
      { text: "Toca muy bien la *guitarra*.", translation: "He plays guitar very well." },
      { text: "Mi *guitarra* necesita cuerdas nuevas.", translation: "My guitar needs new strings." },
      { text: "Aprendió a tocar la *guitarra* el año pasado.", translation: "She learned guitar last year." }
    ],
    467: [
      { text: "Toca el *piano* cada día.", translation: "She plays piano every day." },
      { text: "El *piano* está en la sala.", translation: "The piano is in the living room." },
      { text: "Practica *piano* después de la escuela.", translation: "He practices piano after school." }
    ],
    468: [
      { text: "¿Puedes hacernos una *foto*?", translation: "Can you take a photo of us?" },
      { text: "La *foto* era muy bonita.", translation: "The photo was very nice." },
      { text: "Hicimos muchas *fotos* durante el viaje.", translation: "We took many photos on the trip." }
    ],
    469: [
      { text: "Mi *afición* es pintar.", translation: "My hobby is painting." },
      { text: "Tiene muchas *aficiones*.", translation: "He has many hobbies." },
      { text: "¿Cuál es tu *afición*?", translation: "What's your hobby?" }
    ],
    470: [
      { text: "Vamos de *vacaciones* este verano.", translation: "We're going on holiday this summer." },
      { text: "Las *vacaciones* fueron demasiado cortas.", translation: "The holiday was far too short." },
      { text: "¿Dónde vas de *vacaciones* este año?", translation: "Where are you going on holiday this year?" }
    ],
    471: [
      { text: "Uso *internet* cada día.", translation: "I use the internet every day." },
      { text: "*Internet* no funcionaba ayer.", translation: "The internet was down yesterday." },
      { text: "Miramos el precio en *internet*.", translation: "We checked the price on the internet." }
    ],
    472: [
      { text: "Este *sitio web* es muy útil.", translation: "This website is very useful." },
      { text: "Creamos un *sitio web* nuevo para la empresa.", translation: "We made a new website for the company." },
      { text: "El *sitio web* era fácil de usar.", translation: "The website was easy to use." }
    ],
    473: [
      { text: "He olvidado mi *contraseña*.", translation: "I've forgotten my password." },
      { text: "La *contraseña* debe tener al menos ocho caracteres.", translation: "The password must have at least eight characters." },
      { text: "No compartas tu *contraseña* con otros.", translation: "Don't share your password with others." }
    ],
    474: [
      { text: "Mi *pantalla* está agrietada.", translation: "My screen is cracked." },
      { text: "Compramos una *pantalla* nueva para el ordenador.", translation: "We bought a new screen for the computer." },
      { text: "El texto en la *pantalla* era demasiado pequeño.", translation: "The text on the screen was too small." }
    ],
    475: [
      { text: "Mi *teclado* ya no funciona bien.", translation: "My keyboard is stopping working." },
      { text: "Escribía rápido en el *teclado*.", translation: "He typed quickly on the keyboard." },
      { text: "Compramos un *teclado* nuevo ayer.", translation: "We bought a new keyboard yesterday." }
    ],
    476: [
      { text: "Recibí un *mensaje* de ella hoy.", translation: "I got a message from her today." },
      { text: "¿Puedes enviarme un *mensaje*?", translation: "Can you send me a message?" },
      { text: "El *mensaje* era corto pero amable.", translation: "The message was short but nice." }
    ],
    477: [
      { text: "Veo las *noticias* cada noche.", translation: "I watch the news every evening." },
      { text: "Las *noticias* de hoy eran tristes.", translation: "The news today was sad." },
      { text: "¿Has oído las *noticias*?", translation: "Have you heard the news?" }
    ],
    478: [
      { text: "La *televisión* está en la sala.", translation: "The television is in the living room." },
      { text: "Nuestra *televisión* es bastante vieja.", translation: "Our TV is quite old." },
      { text: "¿Puedes apagar la *televisión*?", translation: "Can you turn off the TV?" }
    ],
    479: [
      { text: "Escucho la *radio* en el coche.", translation: "I listen to the radio in the car." },
      { text: "La *radio* tocaba música todo el día.", translation: "The radio played music all day." },
      { text: "Compró una *radio* vieja en el mercadillo.", translation: "He bought an old radio at the flea market." }
    ],
    480: [
      { text: "Compró una *cámara* nueva el año pasado.", translation: "She bought a new camera last year." },
      { text: "Mi *cámara* hace fotos bonitas.", translation: "My camera takes nice pictures." },
      { text: "Olvidó la *cámara* en casa.", translation: "He forgot the camera at home." }
    ],
    481: [
      { text: "Me gusta *también* el café.", translation: "I also like coffee." },
      { text: "Ella viene *también* esta noche.", translation: "She's also coming tonight." },
      { text: "Tenemos que *también* acordarnos de comprar pan.", translation: "We also need to remember to buy bread." }
    ],
    482: [
      { text: "*Solamente* tengo cinco minutos.", translation: "I only have five minutes." },
      { text: "Costó *solamente* cien euros.", translation: "It only cost a hundred euros." },
      { text: "Comió *solamente* un poco de comida.", translation: "She only ate a little of the food." }
    ],
    483: [
      { text: "Estoy *muy* feliz hoy.", translation: "I'm very happy today." },
      { text: "Hizo *muy* frío ayer.", translation: "It was very cold yesterday." },
      { text: "Es *muy* buena en matemáticas.", translation: "She's very good at math." }
    ],
    484: [
      { text: "*Quizás* podamos vernos mañana.", translation: "Maybe we can meet tomorrow." },
      { text: "*Quizás* venga a la fiesta.", translation: "She might come to the party." },
      { text: "*Quizás* haga sol mañana.", translation: "Maybe it'll be sunny tomorrow." }
    ],
    485: [
      { text: "*Ya* he comido.", translation: "I've already eaten." },
      { text: "¿*Ya* estás listo?", translation: "Are you already done?" },
      { text: "*Ya* se ha ido a casa.", translation: "She has already gone home." }
    ],
    486: [
      { text: "Empezamos el año nuevo en *enero*.", translation: "We start the new year in January." },
      { text: "Hace frío en *enero*.", translation: "It's cold in January." },
      { text: "Mi cumpleaños es en *enero*.", translation: "My birthday is in January." }
    ],
    487: [
      { text: "*Febrero* es el mes más corto.", translation: "February is the shortest month." },
      { text: "Vamos a la montaña en *febrero*.", translation: "We're going to the mountains in February." },
      { text: "La escuela tiene vacaciones de invierno en *febrero*.", translation: "School has winter break in February." }
    ],
    488: [
      { text: "La primavera empieza en *marzo*.", translation: "Spring begins in March." },
      { text: "Nació en *marzo*.", translation: "She was born in March." },
      { text: "Planeamos un viaje en *marzo*.", translation: "We're planning a trip in March." }
    ],
    489: [
      { text: "Llueve mucho en *abril*.", translation: "It rains a lot in April." },
      { text: "La Semana Santa suele ser en *abril*.", translation: "Easter is often in April." },
      { text: "Celebramos su cumpleaños en *abril*.", translation: "We celebrate his birthday in April." }
    ],
    490: [
      { text: "*Mayo* es uno de los meses más bonitos.", translation: "May is one of the nicest months." },
      { text: "Las flores florecen en *mayo*.", translation: "The flowers bloom in May." },
      { text: "Nos casamos en *mayo*.", translation: "We're getting married in May." }
    ],
    491: [
      { text: "La escuela termina en *junio*.", translation: "School ends in June." },
      { text: "El verano empieza en *junio*.", translation: "Summer begins in June." },
      { text: "Celebramos la fiesta en *junio*.", translation: "We celebrate the festival in June." }
    ],
    492: [
      { text: "*Julio* es el mes más caluroso.", translation: "July is the hottest month." },
      { text: "Vamos de vacaciones en *julio*.", translation: "We're going on holiday in July." },
      { text: "Tiene todo *julio* libre.", translation: "She has time off all of July." }
    ],
    493: [
      { text: "La escuela empieza de nuevo en *agosto*.", translation: "School starts again in August." },
      { text: "Todavía hace calor en *agosto*.", translation: "It's still hot in August." },
      { text: "Celebramos el festival en *agosto*.", translation: "We celebrate the festival in August." }
    ],
    494: [
      { text: "El otoño empieza en *septiembre*.", translation: "Autumn begins in September." },
      { text: "Nos mudamos aquí en *septiembre*.", translation: "We moved here in September." },
      { text: "Las hojas empiezan a caer en *septiembre*.", translation: "The leaves start to fall in September." }
    ],
    495: [
      { text: "Hace más frío en *octubre*.", translation: "It gets colder in October." },
      { text: "Celebramos Halloween a finales de *octubre*.", translation: "We celebrate Halloween at the end of October." },
      { text: "Nació en *octubre*.", translation: "She was born in October." }
    ],
    496: [
      { text: "*Noviembre* suele ser gris y húmedo.", translation: "November is often grey and wet." },
      { text: "Encendemos velas en *noviembre*.", translation: "We light candles in November." },
      { text: "A veces nieva en *noviembre*.", translation: "It sometimes snows in November." }
    ],
    497: [
      { text: "Celebramos la Navidad en *diciembre*.", translation: "We celebrate Christmas in December." },
      { text: "*Diciembre* es el mes más oscuro.", translation: "December is the darkest month." },
      { text: "La familia se reúne en *diciembre*.", translation: "The family gathers in December." }
    ],
    498: [
      { text: "¿Qué *fecha* es hoy?", translation: "What's the date today?" },
      { text: "Fijamos una *fecha* para la reunión.", translation: "We set a date for the meeting." },
      { text: "La *fecha* en el billete estaba equivocada.", translation: "The date on the ticket was wrong." }
    ],
    499: [
      { text: "Lo anoté en mi *calendario*.", translation: "I wrote it in my calendar." },
      { text: "El *calendario* está colgado en la pared.", translation: "The calendar hangs on the wall." },
      { text: "Revisa el *calendario* para los días libres.", translation: "Check the calendar for free days." }
    ],
    500: [
      { text: "¡Feliz *cumpleaños*!", translation: "Happy birthday!" },
      { text: "Mi *cumpleaños* es en mayo.", translation: "My birthday is in May." },
      { text: "Celebramos su *cumpleaños* con pastel.", translation: "We celebrated her birthday with cake." }
    ]
  },
  ...
  japanese: {
    ...
    6: [
      { text: "*ごめんなさい*、遅れました。", romanization: "*Gomen nasai*, okuremashita.", translation: "Sorry, I'm late." },
      { text: "*ごめんなさい*、知りませんでした。", romanization: "*Gomen nasai*, shirimasen deshita.", translation: "Sorry, I didn't know." },
      { text: "本当に*ごめんなさい*。", romanization: "Hontou ni *gomen nasai*.", translation: "I'm really sorry." }
    ],
    7: [
      { text: "*朝*ごはんを食べます。", romanization: "*Asa* gohan o tabemasu.", translation: "I eat breakfast in the morning." },
      { text: "*朝*は忙しいです。", romanization: "*Asa* wa isogashii desu.", translation: "Mornings are busy." },
      { text: "*朝*は早く起きます。", romanization: "*Asa* wa hayaku okimasu.", translation: "In the morning I wake up early." }
    ],
    8: [
      { text: "*夕方*に会いましょう。", romanization: "*Yuugata* ni aimashou.", translation: "Let's meet in the evening." },
      { text: "*夕方*は涼しいです。", romanization: "*Yuugata* wa suzushii desu.", translation: "The evening is cool." },
      { text: "*夕方*まで働きます。", romanization: "*Yuugata* made hatarakimasu.", translation: "I work until evening." }
    ],
    9: [
      { text: "いい*日*ですね。", romanization: "Ii *hi* desu ne.", translation: "It's a nice day, isn't it." },
      { text: "その*日*は忙しかったです。", romanization: "Sono *hi* wa isogashikatta desu.", translation: "That day was busy." },
      { text: "楽しい*日*でした。", romanization: "Tanoshii *hi* deshita.", translation: "It was a fun day." }
    ],
    10: [
      { text: "*夜*はテレビを見ます。", romanization: "*Yoru* wa terebi o mimasu.", translation: "At night I watch TV." },
      { text: "静かな*夜*でした。", romanization: "Shizuka na *yoru* deshita.", translation: "It was a quiet night." },
      { text: "*夜*遅くまで起きていました。", romanization: "*Yoru* osoku made okite imashita.", translation: "I stayed up until late at night." }
    ],
    11: [
      { text: "*水*を飲みます。", romanization: "*Mizu* o nomimasu.", translation: "I drink water." },
      { text: "*水*が冷たいです。", romanization: "*Mizu* ga tsumetai desu.", translation: "The water is cold." },
      { text: "コップに*水*を入れました。", romanization: "Koppu ni *mizu* o iremashita.", translation: "I put water in the cup." }
    ],
    12: [
      { text: "この*食べ物*は美味しいです。", romanization: "Kono *tabemono* wa oishii desu.", translation: "This food is delicious." },
      { text: "*食べ物*がたくさんあります。", romanization: "*Tabemono* ga takusan arimasu.", translation: "There's a lot of food." },
      { text: "好きな*食べ物*は何ですか。", romanization: "Suki na *tabemono* wa nan desu ka.", translation: "What's your favorite food?" }
    ],
    13: [
      { text: "*コーヒー*を飲みますか。", romanization: "*Koohii* o nomimasu ka.", translation: "Do you drink coffee?" },
      { text: "*コーヒー*が好きです。", romanization: "*Koohii* ga suki desu.", translation: "I like coffee." },
      { text: "熱い*コーヒー*をください。", romanization: "Atsui *koohii* o kudasai.", translation: "Please give me hot coffee." }
    ],
    14: [
      { text: "*パン*を食べます。", romanization: "*Pan* o tabemasu.", translation: "I eat bread." },
      { text: "美味しい*パン*ですね。", romanization: "Oishii *pan* desu ne.", translation: "This is delicious bread, isn't it." },
      { text: "*パン*を買いました。", romanization: "*Pan* o kaimashita.", translation: "I bought bread." }
    ],
    15: [
      { text: "*家*に帰ります。", romanization: "*Ie* ni kaerimasu.", translation: "I'm going home." },
      { text: "この*家*は大きいです。", romanization: "Kono *ie* wa ookii desu.", translation: "This house is big." },
      { text: "*家*でゆっくりします。", romanization: "*Ie* de yukkuri shimasu.", translation: "I relax at home." }
    ],
    16: [
      { text: "*車*を運転します。", romanization: "*Kuruma* o unten shimasu.", translation: "I drive a car." },
      { text: "新しい*車*を買いました。", romanization: "Atarashii *kuruma* o kaimashita.", translation: "I bought a new car." },
      { text: "*車*が壊れました。", romanization: "*Kuruma* ga kowaremashita.", translation: "The car broke down." }
    ],
    17: [
      { text: "*本*を読みます。", romanization: "*Hon* o yomimasu.", translation: "I read a book." },
      { text: "この*本*は面白いです。", romanization: "Kono *hon* wa omoshiroi desu.", translation: "This book is interesting." },
      { text: "*本*を買いました。", romanization: "*Hon* o kaimashita.", translation: "I bought a book." }
    ],
    18: [
      { text: "*友達*と遊びます。", romanization: "*Tomodachi* to asobimasu.", translation: "I play with my friend." },
      { text: "彼は私の*友達*です。", romanization: "Kare wa watashi no *tomodachi* desu.", translation: "He is my friend." },
      { text: "*友達*に会いました。", romanization: "*Tomodachi* ni aimashita.", translation: "I met my friend." }
    ],
    19: [
      { text: "私の*家族*は四人です。", romanization: "Watashi no *kazoku* wa yonin desu.", translation: "My family has four people." },
      { text: "*家族*と旅行します。", romanization: "*Kazoku* to ryokou shimasu.", translation: "I travel with my family." },
      { text: "*家族*が大好きです。", romanization: "*Kazoku* ga daisuki desu.", translation: "I love my family." }
    ],
    20: [
      { text: "*学校*に行きます。", romanization: "*Gakkou* ni ikimasu.", translation: "I go to school." },
      { text: "この*学校*は新しいです。", romanization: "Kono *gakkou* wa atarashii desu.", translation: "This school is new." },
      { text: "*学校*で日本語を勉強します。", romanization: "*Gakkou* de Nihongo o benkyou shimasu.", translation: "I study Japanese at school." }
    ],
    21: [
      { text: "あの*男の人*は先生です。", romanization: "Ano *otoko no hito* wa sensei desu.", translation: "That man is a teacher." },
      { text: "*男の人*が歩いています。", romanization: "*Otoko no hito* ga aruite imasu.", translation: "A man is walking." },
      { text: "その*男の人*を知っています。", romanization: "Sono *otoko no hito* o shitte imasu.", translation: "I know that man." }
    ],
    22: [
      { text: "あの*女の人*は医者です。", romanization: "Ano *onna no hito* wa isha desu.", translation: "That woman is a doctor." },
      { text: "*女の人*が笑っています。", romanization: "*Onna no hito* ga waratte imasu.", translation: "A woman is laughing." },
      { text: "その*女の人*は親切です。", romanization: "Sono *onna no hito* wa shinsetsu desu.", translation: "That woman is kind." }
    ],
    23: [
      { text: "*子供*が公園で遊んでいます。", romanization: "*Kodomo* ga kouen de asonde imasu.", translation: "The child is playing in the park." },
      { text: "私には*子供*が二人います。", romanization: "Watashi ni wa *kodomo* ga futari imasu.", translation: "I have two children." },
      { text: "その*子供*は元気です。", romanization: "Sono *kodomo* wa genki desu.", translation: "That child is energetic." }
    ],
    24: [
      { text: "*女の子*が歌っています。", romanization: "*Onna no ko* ga utatte imasu.", translation: "The girl is singing." },
      { text: "あの*女の子*は私の娘です。", romanization: "Ano *onna no ko* wa watashi no musume desu.", translation: "That girl is my daughter." },
      { text: "*女の子*が公園にいます。", romanization: "*Onna no ko* ga kouen ni imasu.", translation: "There's a girl in the park." }
    ],
    25: [
      { text: "*男の子*がサッカーをしています。", romanization: "*Otoko no ko* ga sakkaa o shite imasu.", translation: "The boy is playing soccer." },
      { text: "あの*男の子*は私の息子です。", romanization: "Ano *otoko no ko* wa watashi no musuko desu.", translation: "That boy is my son." },
      { text: "*男の子*が笑っています。", romanization: "*Otoko no ko* ga waratte imasu.", translation: "The boy is laughing." }
    ],
    26: [
      { text: "私の*母*は先生です。", romanization: "Watashi no *haha* wa sensei desu.", translation: "My mother is a teacher." },
      { text: "*母*と話しました。", romanization: "*Haha* to hanashimashita.", translation: "I talked with my mother." },
      { text: "*母*の誕生日です。", romanization: "*Haha* no tanjoubi desu.", translation: "It's my mother's birthday." }
    ],
    27: [
      { text: "私の*父*は医者です。", romanization: "Watashi no *chichi* wa isha desu.", translation: "My father is a doctor." },
      { text: "*父*と釣りに行きました。", romanization: "*Chichi* to tsuri ni ikimashita.", translation: "I went fishing with my father." },
      { text: "*父*は優しいです。", romanization: "*Chichi* wa yasashii desu.", translation: "My father is kind." }
    ],
    28: [
      { text: "私の*姉*は看護師です。", romanization: "Watashi no *ane* wa kangoshi desu.", translation: "My older sister is a nurse." },
      { text: "*姉*と買い物に行きました。", romanization: "*Ane* to kaimono ni ikimashita.", translation: "I went shopping with my sister." },
      { text: "*姉*は東京に住んでいます。", romanization: "*Ane* wa Toukyou ni sunde imasu.", translation: "My sister lives in Tokyo." }
    ],
    29: [
      { text: "私の*兄*は大学生です。", romanization: "Watashi no *ani* wa daigakusei desu.", translation: "My older brother is a university student." },
      { text: "*兄*とサッカーをしました。", romanization: "*Ani* to sakkaa o shimashita.", translation: "I played soccer with my brother." },
      { text: "*兄*は背が高いです。", romanization: "*Ani* wa se ga takai desu.", translation: "My brother is tall." }
    ],
    30: [
      { text: "私の*祖母*は元気です。", romanization: "Watashi no *sobo* wa genki desu.", translation: "My grandmother is well." },
      { text: "*祖母*の家に行きました。", romanization: "*Sobo* no ie ni ikimashita.", translation: "I went to my grandmother's house." },
      { text: "*祖母*は料理が上手です。", romanization: "*Sobo* wa ryouri ga jouzu desu.", translation: "My grandmother is good at cooking." }
    ],
    31: [
      { text: "この家は*大きい*です。", romanization: "Kono ie wa *ookii* desu.", translation: "This house is big." },
      { text: "*大きい*犬がいます。", romanization: "*Ookii* inu ga imasu.", translation: "There's a big dog." },
      { text: "もっと*大きい*ものが欲しいです。", romanization: "Motto *ookii* mono ga hoshii desu.", translation: "I want a bigger one." }
    ],
    32: [
      { text: "この部屋は*小さい*です。", romanization: "Kono heya wa *chiisai* desu.", translation: "This room is small." },
      { text: "*小さい*猫がいます。", romanization: "*Chiisai* neko ga imasu.", translation: "There's a small cat." },
      { text: "もっと*小さい*ものが欲しいです。", romanization: "Motto *chiisai* mono ga hoshii desu.", translation: "I want a smaller one." }
    ],
    33: [
      { text: "これは*良い*本です。", romanization: "Kore wa *yoi* hon desu.", translation: "This is a good book." },
      { text: "天気が*良い*です。", romanization: "Tenki ga *yoi* desu.", translation: "The weather is good." },
      { text: "*良い*一日でした。", romanization: "*Yoi* ichinichi deshita.", translation: "It was a good day." }
    ],
    34: [
      { text: "これは*悪い*考えです。", romanization: "Kore wa *warui* kangae desu.", translation: "This is a bad idea." },
      { text: "天気が*悪い*です。", romanization: "Tenki ga *warui* desu.", translation: "The weather is bad." },
      { text: "気分が*悪い*です。", romanization: "Kibun ga *warui* desu.", translation: "I feel bad." }
    ],
    35: [
      { text: "これは*新しい*車です。", romanization: "Kore wa *atarashii* kuruma desu.", translation: "This is a new car." },
      { text: "*新しい*本を買いました。", romanization: "*Atarashii* hon o kaimashita.", translation: "I bought a new book." },
      { text: "*新しい*先生が来ました。", romanization: "*Atarashii* sensei ga kimashita.", translation: "A new teacher has come." }
    ],
    36: [
      { text: "これは*古い*家です。", romanization: "Kore wa *furui* ie desu.", translation: "This is an old house." },
      { text: "*古い*本を読んでいます。", romanization: "*Furui* hon o yonde imasu.", translation: "I'm reading an old book." },
      { text: "この車は*古い*です。", romanization: "Kono kuruma wa *furui* desu.", translation: "This car is old." }
    ],
    37: [
      { text: "今日は*暖かい*です。", romanization: "Kyou wa *atatakai* desu.", translation: "Today is warm." },
      { text: "*暖かい*スープが好きです。", romanization: "*Atatakai* suupu ga suki desu.", translation: "I like warm soup." },
      { text: "この部屋は*暖かい*です。", romanization: "Kono heya wa *atatakai* desu.", translation: "This room is warm." }
    ],
    38: [
      { text: "今日は*寒い*です。", romanization: "Kyou wa *samui* desu.", translation: "Today is cold." },
      { text: "冬はとても*寒い*です。", romanization: "Fuyu wa totemo *samui* desu.", translation: "Winter is very cold." },
      { text: "外は*寒い*です。", romanization: "Soto wa *samui* desu.", translation: "It's cold outside." }
    ],
    39: [
      { text: "この車は*速い*です。", romanization: "Kono kuruma wa *hayai* desu.", translation: "This car is fast." },
      { text: "彼は*速い*です。", romanization: "Kare wa *hayai* desu.", translation: "He is fast." },
      { text: "*速い*電車に乗ります。", romanization: "*Hayai* densha ni norimasu.", translation: "I take the fast train." }
    ],
    40: [
      { text: "このバスは*遅い*です。", romanization: "Kono basu wa *osoi* desu.", translation: "This bus is slow." },
      { text: "彼の返事は*遅い*です。", romanization: "Kare no henji wa *osoi* desu.", translation: "His reply is slow." },
      { text: "今日は少し*遅い*です。", romanization: "Kyou wa sukoshi *osoi* desu.", translation: "Today I'm a bit late." }
    ],
    41: [
      { text: "*私*は学生です。", romanization: "*Watashi* wa gakusei desu.", translation: "I am a student." },
      { text: "*私*は日本語を勉強しています。", romanization: "*Watashi* wa Nihongo o benkyou shite imasu.", translation: "I am studying Japanese." },
      { text: "これは*私*の本です。", romanization: "Kore wa *watashi* no hon desu.", translation: "This is my book." }
    ],
    42: [
      { text: "*あなた*は学生ですか。", romanization: "*Anata* wa gakusei desu ka.", translation: "Are you a student?" },
      { text: "*あなた*が好きです。", romanization: "*Anata* ga suki desu.", translation: "I like you." },
      { text: "これは*あなた*の本ですか。", romanization: "Kore wa *anata* no hon desu ka.", translation: "Is this your book?" }
    ],
    43: [
      { text: "*彼*は医者です。", romanization: "*Kare* wa isha desu.", translation: "He is a doctor." },
      { text: "*彼*は日本人です。", romanization: "*Kare* wa Nihonjin desu.", translation: "He is Japanese." },
      { text: "*彼*と話しました。", romanization: "*Kare* to hanashimashita.", translation: "I talked with him." }
    ],
    44: [
      { text: "*彼女*は先生です。", romanization: "*Kanojo* wa sensei desu.", translation: "She is a teacher." },
      { text: "*彼女*はとても親切です。", romanization: "*Kanojo* wa totemo shinsetsu desu.", translation: "She is very kind." },
      { text: "*彼女*と会いました。", romanization: "*Kanojo* to aimashita.", translation: "I met her." }
    ],
    45: [
      { text: "*私たち*は友達です。", romanization: "*Watashitachi* wa tomodachi desu.", translation: "We are friends." },
      { text: "*私たち*は学生です。", romanization: "*Watashitachi* wa gakusei desu.", translation: "We are students." },
      { text: "これは*私たち*の家です。", romanization: "Kore wa *watashitachi* no ie desu.", translation: "This is our house." }
    ],
    46: [
      { text: "*あなたたち*は学生ですか。", romanization: "*Anatatachi* wa gakusei desu ka.", translation: "Are you all students?" },
      { text: "*あなたたち*は友達ですか。", romanization: "*Anatatachi* wa tomodachi desu ka.", translation: "Are you all friends?" },
      { text: "これは*あなたたち*の部屋です。", romanization: "Kore wa *anatatachi* no heya desu.", translation: "This is your (plural) room." }
    ],
    47: [
      { text: "*彼ら*は学生です。", romanization: "*Karera* wa gakusei desu.", translation: "They are students." },
      { text: "*彼ら*は日本から来ました。", romanization: "*Karera* wa Nihon kara kimashita.", translation: "They came from Japan." },
      { text: "*彼ら*と話しました。", romanization: "*Karera* to hanashimashita.", translation: "I talked with them." }
    ],
    48: [
      { text: "これは*私の*本です。", romanization: "Kore wa *watashi no* hon desu.", translation: "This is my book." },
      { text: "*私の*家族は四人です。", romanization: "*Watashi no* kazoku wa yonin desu.", translation: "My family has four people." },
      { text: "これは*私の*車です。", romanization: "Kore wa *watashi no* kuruma desu.", translation: "This is my car." }
    ],
    49: [
      { text: "これは*あなたの*本ですか。", romanization: "Kore wa *anata no* hon desu ka.", translation: "Is this your book?" },
      { text: "*あなたの*名前は何ですか。", romanization: "*Anata no* namae wa nan desu ka.", translation: "What is your name?" },
      { text: "これは*あなたの*車ですか。", romanization: "Kore wa *anata no* kuruma desu ka.", translation: "Is this your car?" }
    ],
    50: [
